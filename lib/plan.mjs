...
<title>hurl.page · reports</title>
<link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='26' height='26' x='3' y='3' rx='7' fill='%23cf4b3e' transform='rotate(12 16 16)'/%3E%3C/svg%3E">
<style>
  :root{--bg:#fbfafb;--fg:#1e1924;--muted:#7c7482;--border:#e8e5ea;--nav:#fff;--brand:#cf4b3e}
...
<body>
<nav>
  <a class="brand" href="https://hurl.page" target="_blank" rel="noopener">
...
if (mode === "single") {
  ...
  note(`hurl.page: deploying ${r.emoji || ""} ${r.label}${r.cand ? ` (${r.cand})` : ""}`);
  ...
  note(`hurl.page: multi-report drop (${resolved.length}) → ${names}`);
